...
export const PT_PATHOLOGY_DATA = {
  cefalea: {
    ...
    paragraphs: [
      ...
      "Na Kinésica combinamos terapia manual e reeducação postural. Integramos osteopatia, abordagem de ATM, manipulações suaves e RPG para liberar tensões e melhorar o controle do pescoço e da cintura escapular.",
  ...
  dorsalgia: {
    ...
    paragraphs: [
      ...
      "Na Kinésica combinamos terapia manual e trabalho postural para liberar a região torácica. Usamos osteopatia e manipulações específicas quando indicado, além de RPG e cadeias musculares para reorganizar a postura.",
  ...
  lumbalgia: {
    ...
    paragraphs: [
      ...
      "Na Kinésica avaliamos postura, mobilidade lombo-pélvica e controle de core. Integramos terapia manual, osteopatia e manipulações suaves quando indicado, além de exercícios graduais para estabilidade e mobilidade.",
  ...
  ciatalgia: {
    ...
    paragraphs: [
      ...
      "Na Kinésica avaliamos mobilidade lombar, quadril e sensibilidade neural. Utilizamos neurodinâmica, técnicas manuais e osteopatia para reduzir compressão e melhorar o deslizamento do nervo.",
  ...
  cervicobraquialgia: {
    ...
    paragraphs: [
      ...
      "Na Kinésica avaliamos postura, mobilidade cervical e deslizamento neural. Utilizamos terapia manual, manipulações suaves quando indicado, neurodinâmica e RPG para abrir espaço e reduzir compressão.",
  ...
  pubalgia: {
    ...
    paragraphs: [
      ...
      "Sem manejo adequado, torna treinos e partidas dolorosos, reduz explosão e pode gerar compensações lombares ou de joelho.",
      "Na Kinésica avaliamos mobilidade de quadril, controle lombo-pélvico e carga de treino. Usamos terapia manual para liberar tecidos, osteopatia e manipulações suaves quando indicado.",
  ...
  gonalgia: {
    ...
    paragraphs: [
      ...
      "Na Kinésica avaliamos marcha, mobilidade de quadril/tornozelo e controle de joelho. Usamos terapia manual, cadeias musculares e manipulações específicas quando indicado.",
  ...
  talalgia: {
    ...
    paragraphs: [
      ...
      "Na Kinésica avaliamos mobilidade de tornozelo, apoio do pé e carga recente. Utilizamos terapia manual, liberação de tecidos e exercícios específicos para fáscia e tendão.",
  ...
  "dolor-sacriiliaco": {
    ...
    paragraphs: [
      ...
      "Na Kinésica avaliamos alinhamento, mobilidade e controle do core e glúteos. Aplicamos terapia manual para equilibrar a articulação e exercícios para estabilidade.",
      "Orientamos estratégias de movimentar-se e levantar cargas sem agravar a região, garantindo retorno seguro às atividades.",
    ],
    complications: [
  ...
  "hernia-disco": {
    ...
    paragraphs: [
      ...
      "Na Kinésica avaliamos mobilidade, sinais neurais e tolerância a carga. Usamos terapia manual, neurodinâmica e orientações específicas para posições de alívio.",
  ...
  "protrusion-discal": {
    ...
    paragraphs: [
      ...
      "Na Kinésica avaliamos postura, mobilidade e sinais de irritação. Aplicamos terapia manual suave, orientações de alívio e exercícios de estabilidade.",
  ...
  hipercifosis: {
    ...
    paragraphs: [
      ...
      "Na Kinésica usamos terapia manual, trabalho de cadeias musculares e RPG para reorganizar a postura e melhorar a mobilidade torácica.",
  ...
  hiperlordosis: {
    ...
    paragraphs: [
      ...
      "Na Kinésica avaliamos alinhamento pélvico, mobilidade e controle de core. Usamos terapia manual para liberar tecidos e RPG para reorganizar a postura.",
  ...
  "dorso-plano": {
    ...
    paragraphs: [
      ...
      "Na Kinésica trabalhamos mobilidade torácica, cadeias musculares e RPG para restaurar a curva fisiológica e distribuir melhor as cargas.",
  ...
  "genu-valgo": {
    ...
    paragraphs: [
      ...
      "Na Kinésica avaliamos alinhamento dinâmico, mobilidade de quadril/tornozelo e padrão de marcha. Usamos cadeias musculares e exercícios de controle para corrigir o vetor de força.",
  ...
  "genu-varo": {
    ...
    paragraphs: [
      ...
      "Na Kinésica avaliamos alinhamento, mobilidade e controle muscular. Usamos terapia manual quando necessário e exercícios para melhorar distribuição de carga.",
  ...
  "pies-planos": {
    ...
    paragraphs: [
      ...
      "Na Kinésica avaliamos apoio, mobilidade de tornozelo e controle de joelho/quadril. Usamos exercícios específicos para fortalecer musculatura intrínseca e estabilizar o arco.",
      "Orientamos calçados, palmilhas quando indicado e progressão de carga para caminhar e correr sem dor.",
    ],
    complications: [
  ...
  escoliosis: {
    ...
    paragraphs: [
      ...
      "Na Kinésica avaliamos mobilidade, controle muscular e padrão respiratório. Usamos terapia manual, cadeias musculares e RPG para equilibrar tensões.",
  ...
  "epicondilitis-lateral": {
    ...
    paragraphs: [
      ...
      "Na Kinésica usamos terapia manual, técnicas de liberação, neurodinâmica quando indicado e progressão de carga específica para extensores.",
  ...
  "epicondilitis-medial": {
    ...
    paragraphs: [
      ...
      "Na Kinésica aplicamos terapia manual, mobilizações e exercícios graduais para flexores/pronadores, com neurodinâmica quando necessário.",
  ...
  "impingement-subacromial": {
    ...
    paragraphs: [
      ...
      "Na Kinésica avaliamos mobilidade de ombro e escápula. Utilizamos terapia manual, exercícios de controle escapular e fortalecimento progressivo do manguito.",
    ...
    complications: [
      ...
      "Limitação para esportes overhead",
  ...
  "manguito-rotador": {
    ...
    paragraphs: [
      ...
      "Na Kinésica avaliamos mobilidade, força e controle. Aplicamos terapia manual para dor e rigidez, e um plano de fortalecimento progressivo do manguito e escápula.",
  ...
  radiculopatia: {
    ...
    paragraphs: [
      ...
      "Na Kinésica avaliamos sinais neurológicos, mobilidade e fatores de compressão. Usamos neurodinâmica, terapia manual e orientações de alívio.",
  ...
  meniscopatia: {
    ...
    paragraphs: [
      ...
      "Na Kinésica avaliamos mobilidade, alinhamento e estabilidade do joelho. Usamos terapia manual, controle de carga e exercícios para estabilizar e fortalecer.",
  ...
  "fascitis-plantar": {
    ...
    paragraphs: [
      ...
      "Na Kinésica usamos terapia manual, liberação da fáscia, exercícios de fortalecimento do pé e panturrilha, e neurodinâmica quando indicado.",
  ...
  cervicalgia: {
    ...
    paragraphs: [
      ...
      "Na Kinésica combinamos terapia manual, mobilizações suaves e RPG para reduzir tensão e melhorar controle cervical.",
    ...
    complications: [
      ...
      "Cefaleias tensional associadas",
