(function () {
  ...
  var labels = {
    ...
    "dorsalgia": { es: "Dorsalgia", en: "Upper back pain", fr: "Dorsalgie" },
    "lumbalgia": { es: "Lumbalgia", en: "Low back pain", fr: "Lombalgie" },
    "ciatalgia": { es: "Ciatalgia", en: "Ciatalgia", fr: "Ciatalgie" },
    "cervicobraquialgia": { es: "Cervicobraquialgia", en: "Cervicobrachialgia", fr: "Cervicobrachialgie" },
    ...
    "genu-valgo": { es: "Genu valgo", en: "Knee valgus", fr: "Genu valgum" },
    "genu-varo": { es: "Genu varo", en: "Knee varus", fr: "Genu varum" },
    "pies-planos": { es: "Pies planos", en: "Flat feet", fr: "Pieds plats" },
    "escoliosis": { es: "Escoliosis", en: "Scoliosis", fr: "Scoliose" },
    "epicondilitis-lateral": { es: "Epicondilitis lateral", en: "Tennis elbow", fr: "Épicondylite latérale" },
    "epicondilitis-medial": { es: "Epicondilitis medial", en: "Golfer’s elbow", fr: "Épicondylite médiale" },
    "impingement-subacromial": { es: "Impingement subacromial", en: "Subacromial impingement", fr: "Conflit sous-acromial" },
    "manguito-rotador": { es: "Manguito rotador", en: "Rotator cuff", fr: "Coiffe des rotateurs" },
    ...
    "fascitis-plantar": { es: "Fascitis plantar", en: "Plantar fasciitis", fr: "Fasciite plantaire" },
    "cervicalgia": { es: "Cervicalgia", en: "Neck pain", fr: "Cervicalgie" },
    pubalgia: { es: "Pubalgia", en: "Pubalgia", fr: "Pubalgie" },
    gonalgia: { es: "Gonalgia", en: "Knee pain", fr: "Gonalgie" },
    talalgia: { es: "Talalgia", en: "Heel pain", fr: "Talalgie" },
    "dolor-sacriiliaco": {
